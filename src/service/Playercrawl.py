...
# url_eachTeam = f'https://statiz.sporki.com/team/?m=seasonBacknumber&t_code=2002&year=2024'
# wd.get(url_eachTeam)
#
# # 모든 <a> 태그 찾기
# links = wd.find_elements(By.XPATH, '//div[@class="uniform"]//a')
# # href 추출
# hrefs = [link.get_attribute('href') for link in links if link.get_attribute('href')]
#
# # 결과 출력
# print("Extracted hrefs:")
# for href in hrefs:
#     players.append(href.split("p_no=")[1])
#     print(href)
# print(players)
#
# for eachPlayer in players:
#     url_eachPlayer=f'https://statiz.sporki.com/player/?m=year&p_no={eachPlayer}'
#     wd.get(url_eachPlayer)
#
#     stat_elements = wd.find_elements(By.XPATH, '/html/body/div[2]/div[5]/section/div[5]/table/tbody[1]/tr')
#     stat = [t.text for t in stat_elements if t.text]
#     for stats in stat:
#         print(stats)
#
